...
import {MatriculaRealizarComponent} from './matricula-realizar/matricula-realizar.component';
...
@NgModule({
  ...
  exports: [MatriculasListarComponent],
  declarations: [MatriculasListarComponent, MatriculaRealizarComponent],
